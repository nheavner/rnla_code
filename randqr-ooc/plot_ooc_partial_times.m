...
p1 = plot(n_cpqr_ooc(1:length(t_cpqr_in)), t_cpqr_in ./ n_cpqr_ooc(1:length(t_cpqr_in)).^2,'ko-',...
		...
		n_cpqr_ooc_pp, t_cpqr_ssd_pp ./ n_cpqr_ooc_pp.^2, 'rs--',...
		n_cpqr_ooc_pp(1:length(t_cpqr_hdd_pp)), t_cpqr_hdd_pp ./ n_cpqr_ooc_pp(1:length(t_cpqr_hdd_pp)).^2, 'bd--',...
		n_cpqr_ooc_left, t_cpqr_ssd_left ./ n_cpqr_ooc_left.^2, 'rs-.',...
		n_cpqr_ooc_left(1:length(t_cpqr_hdd_left)), t_cpqr_hdd_left ./ n_cpqr_ooc_left(1:length(t_cpqr_hdd_left)).^2, 'bd-.');
ax = gca;
set(ax,'fontsize',16);
