...
/*
  ...
  for ( i=0; i < sizeof( n_A ) / sizeof( int ); i++ ) {
	...
	magma_malloc( A_mm_d, n_A[ i ] * n_A[ i ] * sizeof( double ) );
	magma_malloc( B_d, n_A[ i ] * n_A[ i ] * sizeof( double ) );
	magma_malloc( C_d, n_A[ i ] * n_A[ i ] * sizeof( double ) );
